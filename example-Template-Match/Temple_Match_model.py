...
# TEST
#########################
templates = './amenity_firestation/template'
img_pos = './amenity_firestation/firestation/16_32533_21699.png'
img_neg = './amenity_firestation/not_firestation/16_32554_21757.png'

threshold = 0.9
        
TemplateMatch(templates, img_pos, threshold)
TemplateMatch(templates, img_neg, threshold)
